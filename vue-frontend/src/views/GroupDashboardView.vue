          ...
          <section class="action-center surface">
            ...
            <div v-if="actionItems.length" class="action-list">
              <router-link
                ...
                class="action-row"
              >
                <span :class="['action-icon', item.tone]" aria-hidden="true">{{ item.icon }}</span>
                <div>
          ...
          <section class="recent surface">
            ...
            <div class="asset-row">
              <router-link
                ...
                class="mini-asset"
              >
                <span aria-hidden="true">{{ categoryIcon(asset.category) }}</span>
                <div>
...
.green { color: #0b6b57; background: #e8f5f1; }
.blue { color: #38598b; background: #edf2fb; }
.amber { color: #9a5b00; background: #fff4df; }
.purple { color: #7046a1; background: #f2ecf8; }
.dark { color: #fff; background: #172b3a; }
...
.ai-module {
  color: #fff;
  background: linear-gradient(130deg, #172b3a, #263f52);
  border-radius: var(--radius-lg);
  box-shadow: var(--shadow-sm);
}
.ai-module strong { color: #fff; }
.ai-module p { color: #b9c7d1; font-size: 10px; }
.ai-module b { color: #8ce0c7; }
.recent { padding: 22px; }
.asset-row {
  display: grid;
