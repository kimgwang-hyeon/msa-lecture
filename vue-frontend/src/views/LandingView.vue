...
.hero { position: relative; overflow: hidden; margin: 18px; padding: 86px 0 82px; background: linear-gradient(135deg, #edf5f1 0%, #fbfcfa 62%, #f7f1e9 100%); border: 1px solid rgba(207, 222, 216, .72); border-radius: var(--radius-xl); }
.hero::after { content: ''; position: absolute; width: 430px; height: 430px; right: -170px; top: -210px; border: 70px solid rgba(53, 109, 99, .055); border-radius: 50%; }
...
.workflow-card { padding: 26px; background: rgba(255,255,255,.86); border: 1px solid rgba(200, 216, 210, .82); border-radius: var(--radius-xl); box-shadow: var(--shadow-lg); backdrop-filter: blur(16px); }
...
.workflow-item { display: grid; grid-template-columns: 26px 38px 1fr auto; align-items: center; gap: 11px; padding: 13px; background: rgba(244, 248, 246, .84); border: 1px solid #dfe8e4; border-radius: 11px; animation: fadeInUp var(--duration-slow) var(--ease-out) both; animation-delay: var(--delay); }
...
.category-card { display: flex; align-items: center; gap: 15px; padding: 21px; background: linear-gradient(145deg, rgba(255,255,255,.94), rgba(241,246,243,.82)); border: 1px solid var(--color-border); border-radius: var(--radius-lg); box-shadow: var(--shadow-sm); transition: var(--transition); }
.category-card:hover { transform: translateY(-4px); box-shadow: var(--shadow-md); }
.category-card:nth-child(2) { transform: translateY(-7px); border-color: #c5d8d1; background: linear-gradient(145deg, #f6faf8, #eaf3ef); }
.category-card:nth-child(2):hover { transform: translateY(-10px); }
...
.why-section { width: min(1180px, calc(100% - 48px)); margin: 28px auto 20px; padding: 62px 0; color: var(--color-text-primary); background: linear-gradient(125deg, #edf5f1, #fbf8f2); border: 1px solid #d9e5df; border-radius: var(--radius-xl); }
...
.benefit { display: grid; grid-template-columns: 42px 1fr; gap: 16px; padding: 17px 19px; background: rgba(255,255,255,.76); border: 1px solid #dce6e1; border-radius: var(--radius-lg); box-shadow: var(--shadow-sm); transition: var(--transition); }
...
@media (max-width: 520px) {
  ...
  .category-card:nth-child(2), .category-card:nth-child(2):hover { transform: none; }
