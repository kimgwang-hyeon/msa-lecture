...
.role-filter button.active { color: #fff; background: var(--color-primary); }
...
.tone-1 { background: #38598b; }
.tone-2 { background: #8a5b35; }
.tone-3 { background: #6c4f8f; }
.role {
  padding: 5px 8px;
  border-radius: 999px;
  font-size: 9px;
