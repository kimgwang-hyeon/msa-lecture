...
.large-avatar {
  ...
  place-items: center;
  color: #fff;
  background: linear-gradient(140deg, var(--color-navy), var(--color-primary));
...
.principle {
  ...
  padding: 23px;
  color: #fff;
  background: linear-gradient(120deg, #102a43, #14493f);
}
.principle > span { color: #72dbc0; font-size: 9px; font-weight: 800; letter-spacing: .1em; }
.principle h2 { font-size: 14px; }
.principle p { margin-top: 4px; color: #c2d0d7; font-size: 10px; line-height: 1.55; }
