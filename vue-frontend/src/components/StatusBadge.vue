...
.tone-pending { color: var(--color-warning); background: var(--color-warning-light); border-color: rgba(138, 91, 37, .18); }
.tone-active, .tone-complete { color: var(--color-success); background: var(--color-success-light); border-color: rgba(38, 112, 91, .18); }
